@echo off
echo ========================================
echo REDÉMARRAGE BACKEND ET TEST E-COMPTA-IA
echo ========================================
echo.

echo [1/4] Arrêt du backend...
cd docker
...
echo [3/4] Attente du démarrage (60 secondes)...
timeout /t 60 /nobreak > nul
echo.

echo [4/4] Test des contrôleurs...
echo.
...
echo ========================================
echo.
echo Backend redémarré et testé !
echo.
pause
