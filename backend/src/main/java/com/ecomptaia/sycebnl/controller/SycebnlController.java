...
public class SycebnlController {
    ...
    public ResponseEntity<SycebnlOrganizationService.SycebnlOrganization> createOrganization(
            @RequestParam Long companyId,
            @RequestBody CreateOrganizationRequest request) {
        
        SycebnlOrganizationService.SycebnlOrganization organization = new SycebnlOrganizationService.SycebnlOrganization();
        
        SycebnlOrganizationService.SycebnlOrganization createdOrganization = organizationService.createOrganization(companyId, organization);
    ...
    public ResponseEntity<SycebnlOrganizationService.SycebnlOrganization> getOrganization(@PathVariable Long organizationId) {
        SycebnlOrganizationService.SycebnlOrganization organization = organizationService.getOrganization(organizationId);
    ...
    public ResponseEntity<Page<SycebnlOrganizationService.SycebnlOrganization>> getOrganizations(
            @RequestParam Long companyId,
            Pageable pageable) {
        Page<SycebnlOrganizationService.SycebnlOrganization> organizations = organizationService.getOrganizations(companyId, pageable);
    ...
    public ResponseEntity<SycebnlOrganizationService.SycebnlOrganization> updateOrganization(
            @PathVariable Long organizationId,
            @RequestBody SycebnlOrganizationService.SycebnlOrganization updatedOrganization) {
        
        SycebnlOrganizationService.SycebnlOrganization organization = organizationService.updateOrganization(organizationId, updatedOrganization);
        return ResponseEntity.ok(organization);
    }
    ...
    public ResponseEntity<List<SycebnlOrganizationService.SycebnlOrganization>> getOrganizationsDueForAudit(@RequestParam Long companyId) {
        List<SycebnlOrganizationService.SycebnlOrganization> organizations = organizationService.getOrganizationsDueForAudit();
        return ResponseEntity.ok(organizations);
    }
    ...
    public ResponseEntity<List<SycebnlOrganizationService.SycebnlOrganization>> getNonCompliantOrganizations(@RequestParam Long companyId) {
        List<SycebnlOrganizationService.SycebnlOrganization> organizations = organizationService.getNonCompliantOrganizations();
        return ResponseEntity.ok(organizations);
    }
    ...
    public ResponseEntity<List<SycebnlOrganizationService.SycebnlOrganization>> searchOrganizations(
            @RequestParam Long companyId,
            @RequestParam String searchTerm) {
        List<SycebnlOrganizationService.SycebnlOrganization> organizations = organizationService.searchOrganizations(searchTerm);
        return ResponseEntity.ok(organizations);
    }
